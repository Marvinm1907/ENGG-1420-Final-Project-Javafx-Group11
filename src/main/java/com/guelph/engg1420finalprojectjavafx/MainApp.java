...
// STAGE -> SCENE -> H/V Box
// Main app: manages scene switching and holds all shared state
public class MainApp extends Application {
    private Stage primaryStage;

    // Shared state — passed into views that need them
    ...
    // If currEvent is null -> create mode; otherwise -> edit mode
